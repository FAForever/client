...
class Updater(QtCore.QObject):
    ...
    def fetchFile(self, url, toFile):
        try:
            ...
            QMessageBox.information(None, "Download Failed",
    ...
    def doUpdate(self):
        ...
        if self.result == self.RESULT_CANCEL:
            ...
            QMessageBox.information(QtWidgets.QApplication.activeWindow(), "Installation Required",
                                          "You can't play without a legal version of Forged Alliance.")
        elif self.result == self.RESULT_BUSY:
            QMessageBox.information(QtWidgets.QApplication.activeWindow(), "Server Busy",
