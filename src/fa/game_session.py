...
class GameSession(QObject):
    ...
    def __init__(self, client, player_id, player_login):
        ...
        self.ice_adapter_client.call("status", callback_result=self.onIceStatus)

        # Reserve one relay, to make the Windows firewall dialog pop up on fresh installations
        self.ice_adapter_client.call("reserveRelays", args=[1])
