...
import trueskill
import trueskill.Rating as Rating
...
class Statpage(QMainWindow):
    ...
    def on_draw(self):
        ...
        if self.compare_cb.isChecked() :
            ...
            # I guess this block of madness is an inlined trueskill calculation?
            # OH GOD WHY.
            ...
            # Calculate the game quality between the selected user and the logged in user.
            selected_rating = trueskill.Rating(self.mu, self.sigma)
            logged_in_rating = Rating(self.playermu, self.playersigma)
            gamequality = trueskill.quality_1vs1(selected_rating, logged_in_rating)
