...
class Chatter(QtWidgets.QTableWidgetItem):
    ...
    def update(self):
        ...
        if url:
            if int(QtCore.QUrlQuery(url).queryItemValue("uid")) in client.instance.games.games:
                game = client.instance.games.games[int(QtCore.QUrlQuery(url).queryItemValue("uid"))]
